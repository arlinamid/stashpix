...
packaging\build.ps1                 # bundle + MSI, version 1.3.0
packaging\build.ps1 -Version 1.3.0  # set the MSI version
...
wix build packaging\wix\Package.wxs -d StageDir=dist\\stashpix -d Version=1.3.0 -o packaging\out\stashpix-1.3.0.msi
```
