...
packaging\build.ps1                 # bundle + MSI, version 1.5.1
packaging\build.ps1 -Version 1.5.1  # set the MSI version
...
wix build packaging\wix\Package.wxs -d StageDir=dist\\stashpix -d Version=1.5.1 -o packaging\out\stashpix-1.5.1.msi
```
